...
<component :is="layout"></component>
    ...
    <div>
      <a-radio-group v-model="currLayout">
        <a-radio value="layout2">布局1</a-radio>
        <a-radio value="layout3">布局2</a-radio>
        <a-radio value="layout4">布局3</a-radio>
        <a-radio value="layout5">布局4</a-radio>
      </a-radio-group>
      <a-radio-group v-model="layoutMode" @change="onChange">
